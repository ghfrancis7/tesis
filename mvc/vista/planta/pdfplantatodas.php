<?php
	...
	include_once("../../modelo/Planta.php");
		...
		$pdf=new PDF_MC_Table('L', 'mm', 'A4');
			...
			$pdf->SetWidths(array(30,30,30,30,30,40,35,35,20));
			$pdf->Cell(30,8,"Nombre",'TRLB',0,'C');
			$pdf->Cell(30,8,"Cliente",'TRLB',0);
			$pdf->Cell(30,8,"Localidad",'TRLB',0);
			$pdf->Cell(30,8,"Direccion",'TRLB',0);
			$pdf->Cell(30,8,"Telefono",'TRLB',0);
...
for($i=0;$i<1;$i++)
    ...
    $pdf->Row(array($row['PlantaNombre'],$row['ClienteNombre'],$row['PlantaLocalidad'],$row['PlantaDireccion'],$row['PlantaTelefono'],$row['PlantaMail'],$row['PlantaFechaAlta'],$row['PlantaFechaBaja'],$row['PlantaEstado']));

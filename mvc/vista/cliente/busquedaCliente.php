...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    <tr>
      <td>
        ...
        <form id="verinactivo" action="ver_cliente_inactivo.php" method="post">
			<input style="width: 200px;" id="button" type="button" onClick="document.getElementById('verinactivo').submit()" value="Ver Clientes Inactivos"/>
		</form>
        </td></tr>
	</tbody></table>
    </div>

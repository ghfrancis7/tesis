<?php
	...
	include_once("../../modelo/Cliente.php");
		...
		$pdf->SetWidths(array(35,35,35,35,35,20));
			...
			$pdf->SetFont("Arial",'',12);
				...
				$controlador = new Cliente();
					$sql= $controlador->listarClienteActivo($idUsuario);
    ...
    $pdf->Row(array($row['ClienteNombre'],$row['ClienteCUIT'],$row['ClienteDireccion'],$row['ClienteTelefono'],$row['ClienteFechaAlta'],$row['ClienteEstado']));

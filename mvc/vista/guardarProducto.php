<?php 
	...
	try {
			...
			$pst = $pdo->mysql->prepare("INSERT INTO producto (ProductoNombre, ProductoPrecio,ProductoFechaAltaDB,ProductoEstado) VALUES (:ProductoNombre,:ProductoPrecio,:ProductoFechaAltaDB,:ProductoEstado)");
